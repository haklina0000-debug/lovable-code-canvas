...
export default function Auth() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate auth - in real implementation, this would use Firebase
    setTimeout(() => {
      setIsLoading(false);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="w-full max-w-md px-4 relative z-10">
        <div className="glass-card glow-border p-8 animate-fade-in">
          {/* Logo */}
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground">
              {mode === "login"
                ...
                : "أنشئ حسابك وابدأ في بناء مواقعك"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-l from-primary to-blue-500 hover:opacity-90 gap-2"
              disabled={isLoading}
            >
              {isLoading ? (
                "جاري التحميل..."
          ...
          <Link
            to="/"
            className="flex items-center justify-center gap-2 mt-4 text-sm text-muted-foreground hover:text-foreground"
          >
